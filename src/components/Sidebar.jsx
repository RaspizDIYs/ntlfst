...
const Sidebar = ({ members, onSelectMember, orgInfo }) => {
    ...
    const [sidebarState, setSidebarState] = useState(0); // 0: collapsed, 1: partially expanded, 2: fully expanded
    ...
    return (
        <div
            className={`sidebar p-2 rounded-lg shadow-2xl flex flex-col items-center space-y-4 max-w-[80px] mx-4 my-6 transition-all duration-300 ${
        ...
        >
                ...
                <div className="flex flex-col items-center">
                    ...
                    {sidebarState === 0 && (
                        <button
                            ...
                            className="hover:text-gray-400 transition mt-1"
                        >
            ...
            {sidebarState > 0 && (
                <button
                    onClick={toggleSidebarState}
                    className="hover:text-gray-400 transition mt-auto"
                >
